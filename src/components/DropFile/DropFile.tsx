...
const StyledLabel = styledEmotion.label<{dragActive: boolean}>`
    ...
    justify-content: center;
    border-radius: 4px;
    border: 2px dashed ${({dragActive, theme}) =>
        dragActive ? theme.palette.customGreen.dark : theme.palette.grey[500]};
    background-color: ${({dragActive, theme}) =>
        dragActive ? theme.palette.customGreen.light : "inherit"}
`
...
const DropFile = React.forwardRef<HTMLInputElement, PropsWithChildren<DropFileProps>>(
